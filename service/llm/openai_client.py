...
class OpenAI_Client:
    ...
    def call(cls, model, messages, **kwargs):
        """
        Generic method to call OpenAI API, handling both streaming and non-streaming cases
        ...
        try:
            ...
            if stream:
                ...
                logger.info(f"Starting non-streaming request to OpenAI API with model {model}")
